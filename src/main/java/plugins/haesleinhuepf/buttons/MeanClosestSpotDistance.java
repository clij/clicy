...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MeanClosestSpotDistanceBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MeanClosestSpotDistance extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MeanClosestSpotDistanceBlock();
