...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MeanClosestSpotDistanceBlock;
...
public class MeanClosestSpotDistance extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_MeanClosestSpotDistanceBlock();
