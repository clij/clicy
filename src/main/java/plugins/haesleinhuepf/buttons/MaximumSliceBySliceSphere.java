...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MaximumSliceBySliceSphereBlock;
...
public class MaximumSliceBySliceSphere extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_MaximumSliceBySliceSphereBlock();
