...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MeanExtensionMapBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MeanExtensionMap extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_MeanExtensionMapBlock();
