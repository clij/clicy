...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Minimum2DBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Minimum2DBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Minimum2DBoxBlock();
