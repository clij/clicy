...
import plugins.haesleinhuepf.implementations.generated.CLIJx_SorensenDiceJaccardIndexBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class SorensenDiceJaccardIndex extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_SorensenDiceJaccardIndexBlock();
