...
import plugins.haesleinhuepf.implementations.generated.CLIJx_BinaryIntersectionBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class BinaryIntersection extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_BinaryIntersectionBlock();
