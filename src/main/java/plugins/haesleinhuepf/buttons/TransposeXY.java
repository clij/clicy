...
import plugins.haesleinhuepf.implementations.generated.CLIJx_TransposeXYBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class TransposeXY extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_TransposeXYBlock();
