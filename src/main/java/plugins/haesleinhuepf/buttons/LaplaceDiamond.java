...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_LaplaceDiamondBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class LaplaceDiamond extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_LaplaceDiamondBlock();
