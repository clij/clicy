...
import plugins.haesleinhuepf.implementations.generated.CLIJx_DetectMinimaBoxBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class DetectMinimaBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_DetectMinimaBoxBlock();
