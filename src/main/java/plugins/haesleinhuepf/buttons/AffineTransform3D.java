...
import plugins.haesleinhuepf.implementations.generated.CLIJx_AffineTransform3DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class AffineTransform3D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_AffineTransform3DBlock();
