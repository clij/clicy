...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DilateSphereSliceBySliceBlock;
...
public class DilateSphereSliceBySlice extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_DilateSphereSliceBySliceBlock();
