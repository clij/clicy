...
import plugins.haesleinhuepf.implementations.generated.CLIJx_DilateSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class DilateSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_DilateSphereBlock();
