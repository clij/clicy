...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ErodeBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ErodeBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ErodeBoxBlock();
