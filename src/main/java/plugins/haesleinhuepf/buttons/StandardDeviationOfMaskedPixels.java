...
import plugins.haesleinhuepf.implementations.generated.CLIJx_StandardDeviationOfMaskedPixelsBlock;
...
public class StandardDeviationOfMaskedPixels extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_StandardDeviationOfMaskedPixelsBlock();
