...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_ResliceRightBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ResliceRight extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_ResliceRightBlock();
