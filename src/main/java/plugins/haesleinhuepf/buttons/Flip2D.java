...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Flip2DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Flip2D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Flip2DBlock();
