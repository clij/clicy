...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ConnectedComponentsLabelingBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ConnectedComponentsLabeling extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ConnectedComponentsLabelingBlock();
