...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_ConnectedComponentsLabelingBlock;
...
public class ConnectedComponentsLabeling extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_ConnectedComponentsLabelingBlock();
