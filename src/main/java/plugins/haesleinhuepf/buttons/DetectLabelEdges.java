...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DetectLabelEdgesBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class DetectLabelEdges extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_DetectLabelEdgesBlock();
