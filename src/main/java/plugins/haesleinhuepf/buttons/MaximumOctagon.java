...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MaximumOctagonBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MaximumOctagon extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MaximumOctagonBlock();
