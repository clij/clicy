...
import plugins.haesleinhuepf.implementations.generated.CLIJx_TranslationRegistrationBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class TranslationRegistration extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_TranslationRegistrationBlock();
