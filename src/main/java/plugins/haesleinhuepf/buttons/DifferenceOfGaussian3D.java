...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DifferenceOfGaussian3DBlock;
...
public class DifferenceOfGaussian3D extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_DifferenceOfGaussian3DBlock();
