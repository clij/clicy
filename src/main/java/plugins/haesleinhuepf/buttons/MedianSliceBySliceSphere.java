...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MedianSliceBySliceSphereBlock;
...
public class MedianSliceBySliceSphere extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MedianSliceBySliceSphereBlock();
