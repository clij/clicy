...
import plugins.haesleinhuepf.implementations.generated.CLIJx_AverageDistanceOfTouchingNeighborsBlock;
...
public class AverageDistanceOfTouchingNeighbors extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_AverageDistanceOfTouchingNeighborsBlock();
