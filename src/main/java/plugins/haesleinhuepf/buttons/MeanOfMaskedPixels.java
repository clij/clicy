...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MeanOfMaskedPixelsBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MeanOfMaskedPixels extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MeanOfMaskedPixelsBlock();
