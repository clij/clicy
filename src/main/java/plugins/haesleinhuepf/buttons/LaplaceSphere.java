...
import plugins.haesleinhuepf.implementations.generated.CLIJx_LaplaceSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class LaplaceSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_LaplaceSphereBlock();
