...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ErodeSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ErodeSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ErodeSphereBlock();
