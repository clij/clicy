...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Maximum3DBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Maximum3DBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Maximum3DBoxBlock();
