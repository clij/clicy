...
import plugins.haesleinhuepf.implementations.generated.CLIJx_CountNonZeroPixels2DSphereBlock;
...
public class CountNonZeroPixels2DSphere extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_CountNonZeroPixels2DSphereBlock();
