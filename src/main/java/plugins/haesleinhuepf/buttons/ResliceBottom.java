...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ResliceBottomBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ResliceBottom extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ResliceBottomBlock();
