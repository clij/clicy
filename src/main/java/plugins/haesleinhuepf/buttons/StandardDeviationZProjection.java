...
import plugins.haesleinhuepf.implementations.generated.CLIJx_StandardDeviationZProjectionBlock;
...
public class StandardDeviationZProjection extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_StandardDeviationZProjectionBlock();
