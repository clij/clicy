...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Scale3DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Scale3D extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Scale3DBlock();
