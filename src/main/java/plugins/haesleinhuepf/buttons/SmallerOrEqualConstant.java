...
import plugins.haesleinhuepf.implementations.generated.CLIJx_SmallerOrEqualConstantBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class SmallerOrEqualConstant extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_SmallerOrEqualConstantBlock();
