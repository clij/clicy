...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_SmallerOrEqualConstantBlock;
...
public class SmallerOrEqualConstant extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_SmallerOrEqualConstantBlock();
