...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_ThresholdIJ_IsoDataBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ThresholdIJ_IsoData extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_ThresholdIJ_IsoDataBlock();
