...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Blur2DBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Blur2D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Blur2DBlock();
