...
import plugins.haesleinhuepf.implementations.generated.CLIJx_CountNonZeroPixelsSliceBySliceSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CountNonZeroPixelsSliceBySliceSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_CountNonZeroPixelsSliceBySliceSphereBlock();
