...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ShowGreyBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ShowGrey extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ShowGreyBlock();
