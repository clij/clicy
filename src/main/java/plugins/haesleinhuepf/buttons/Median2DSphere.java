...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Median2DSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Median2DSphere extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Median2DSphereBlock();
