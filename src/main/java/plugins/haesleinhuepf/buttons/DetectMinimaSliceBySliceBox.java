...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DetectMinimaSliceBySliceBoxBlock;
...
public class DetectMinimaSliceBySliceBox extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_DetectMinimaSliceBySliceBoxBlock();
