...
import plugins.haesleinhuepf.implementations.generated.CLIJx_BinaryXOrBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class BinaryXOr extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_BinaryXOrBlock();
