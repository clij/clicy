...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Crop3DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Crop3D extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Crop3DBlock();
