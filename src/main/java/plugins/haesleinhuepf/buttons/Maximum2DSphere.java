...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Maximum2DSphereBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Maximum2DSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Maximum2DSphereBlock();
