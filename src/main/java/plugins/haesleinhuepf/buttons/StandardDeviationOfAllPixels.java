...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_StandardDeviationOfAllPixelsBlock;
...
public class StandardDeviationOfAllPixels extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_StandardDeviationOfAllPixelsBlock();
