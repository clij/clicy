...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MeanSquaredErrorBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MeanSquaredError extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MeanSquaredErrorBlock();
