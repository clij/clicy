...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MatrixEqualBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MatrixEqual extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MatrixEqualBlock();
