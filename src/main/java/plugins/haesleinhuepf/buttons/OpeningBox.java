...
import plugins.haesleinhuepf.implementations.generated.CLIJx_OpeningBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class OpeningBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_OpeningBoxBlock();
