...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Flip3DBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Flip3D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Flip3DBlock();
