...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_CountTouchingNeighborsBlock;
...
public class CountTouchingNeighbors extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_CountTouchingNeighborsBlock();
