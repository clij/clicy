...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Median3DBoxBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Median3DBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Median3DBoxBlock();
