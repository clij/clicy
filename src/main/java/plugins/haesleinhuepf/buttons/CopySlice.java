...
import plugins.haesleinhuepf.implementations.generated.CLIJx_CopySliceBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CopySlice extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_CopySliceBlock();
