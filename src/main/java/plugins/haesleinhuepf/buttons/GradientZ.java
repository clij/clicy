...
import plugins.haesleinhuepf.implementations.generated.CLIJx_GradientZBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class GradientZ extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_GradientZBlock();
