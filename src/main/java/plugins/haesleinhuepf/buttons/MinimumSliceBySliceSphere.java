...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MinimumSliceBySliceSphereBlock;
...
public class MinimumSliceBySliceSphere extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MinimumSliceBySliceSphereBlock();
