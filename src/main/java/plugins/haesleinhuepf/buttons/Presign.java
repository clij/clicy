...
import plugins.haesleinhuepf.implementations.generated.CLIJx_PresignBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Presign extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_PresignBlock();
