...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_StartTimeTracingBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class StartTimeTracing extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_StartTimeTracingBlock();
