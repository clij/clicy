...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ClosingBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ClosingBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ClosingBoxBlock();
