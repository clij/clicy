...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MeanOfPixelsAboveThresholdBlock;
...
public class MeanOfPixelsAboveThreshold extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MeanOfPixelsAboveThresholdBlock();
