...
import plugins.haesleinhuepf.implementations.generated.CLIJx_TopHatBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class TopHatBox extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_TopHatBoxBlock();
