...
import plugins.haesleinhuepf.implementations.generated.CLIJx_EqualConstantBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class EqualConstant extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_EqualConstantBlock();
