...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_EqualizeMeanIntensitiesOfSlicesBlock;
...
public class EqualizeMeanIntensitiesOfSlices extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_EqualizeMeanIntensitiesOfSlicesBlock();
