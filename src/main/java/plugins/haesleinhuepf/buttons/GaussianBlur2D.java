...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_GaussianBlur2DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class GaussianBlur2D extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_GaussianBlur2DBlock();
