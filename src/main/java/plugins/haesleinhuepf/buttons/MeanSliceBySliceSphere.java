...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MeanSliceBySliceSphereBlock;
...
public class MeanSliceBySliceSphere extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MeanSliceBySliceSphereBlock();
