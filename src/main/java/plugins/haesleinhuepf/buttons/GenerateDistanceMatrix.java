...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_GenerateDistanceMatrixBlock;
...
public class GenerateDistanceMatrix extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_GenerateDistanceMatrixBlock();
