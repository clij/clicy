...
import plugins.haesleinhuepf.implementations.generated.CLIJx_DifferenceOfGaussianInplace3DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class DifferenceOfGaussianInplace3D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_DifferenceOfGaussianInplace3DBlock();
