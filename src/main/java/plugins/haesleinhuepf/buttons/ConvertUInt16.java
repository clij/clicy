...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_ConvertUInt16Block;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ConvertUInt16 extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_ConvertUInt16Block();
