...
import plugins.haesleinhuepf.implementations.generated.CLIJx_GradientXBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class GradientX extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_GradientXBlock();
