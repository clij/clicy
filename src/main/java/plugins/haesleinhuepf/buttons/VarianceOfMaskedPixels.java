...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_VarianceOfMaskedPixelsBlock;
...
public class VarianceOfMaskedPixels extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_VarianceOfMaskedPixelsBlock();
