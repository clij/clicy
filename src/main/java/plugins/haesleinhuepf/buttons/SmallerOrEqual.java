...
import plugins.haesleinhuepf.implementations.generated.CLIJx_SmallerOrEqualBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class SmallerOrEqual extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_SmallerOrEqualBlock();
