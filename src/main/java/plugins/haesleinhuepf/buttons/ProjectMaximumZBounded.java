...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ProjectMaximumZBoundedBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ProjectMaximumZBounded extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ProjectMaximumZBoundedBlock();
