...
import plugins.haesleinhuepf.implementations.generated.CLIJx_SumZProjectionBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class SumZProjection extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_SumZProjectionBlock();
