...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MinimumDistanceOfTouchingNeighborsBlock;
...
public class MinimumDistanceOfTouchingNeighbors extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MinimumDistanceOfTouchingNeighborsBlock();
