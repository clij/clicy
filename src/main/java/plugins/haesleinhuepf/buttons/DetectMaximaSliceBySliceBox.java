...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DetectMaximaSliceBySliceBoxBlock;
...
public class DetectMaximaSliceBySliceBox extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_DetectMaximaSliceBySliceBoxBlock();
