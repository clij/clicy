...
import plugins.haesleinhuepf.implementations.generated.CLIJx_TenengradFusionOf4Block;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class TenengradFusionOf4 extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_TenengradFusionOf4Block();
