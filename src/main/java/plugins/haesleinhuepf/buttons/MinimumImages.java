...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MinimumImagesBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MinimumImages extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MinimumImagesBlock();
