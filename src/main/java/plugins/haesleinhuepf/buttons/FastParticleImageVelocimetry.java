...
import plugins.haesleinhuepf.implementations.generated.CLIJx_FastParticleImageVelocimetryBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class FastParticleImageVelocimetry extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_FastParticleImageVelocimetryBlock();
