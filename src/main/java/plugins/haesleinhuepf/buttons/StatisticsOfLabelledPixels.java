...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_StatisticsOfLabelledPixelsBlock;
...
public class StatisticsOfLabelledPixels extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_StatisticsOfLabelledPixelsBlock();
