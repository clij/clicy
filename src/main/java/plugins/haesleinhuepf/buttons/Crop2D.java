...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Crop2DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Crop2D extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Crop2DBlock();
