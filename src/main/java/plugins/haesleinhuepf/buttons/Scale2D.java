...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Scale2DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Scale2D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Scale2DBlock();
