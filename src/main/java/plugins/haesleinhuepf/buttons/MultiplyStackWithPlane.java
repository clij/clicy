...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MultiplyStackWithPlaneBlock;
...
public class MultiplyStackWithPlane extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MultiplyStackWithPlaneBlock();
