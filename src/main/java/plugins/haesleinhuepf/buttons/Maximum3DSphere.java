...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Maximum3DSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Maximum3DSphere extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Maximum3DSphereBlock();
