...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MinimumOctagonBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MinimumOctagon extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_MinimumOctagonBlock();
