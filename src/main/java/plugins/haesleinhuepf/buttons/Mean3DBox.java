...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Mean3DBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Mean3DBox extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Mean3DBoxBlock();
