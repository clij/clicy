...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MaximumXProjectionBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MaximumXProjection extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MaximumXProjectionBlock();
