...
import plugins.haesleinhuepf.implementations.generated.CLIJx_AffineTransform2DBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class AffineTransform2D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_AffineTransform2DBlock();
