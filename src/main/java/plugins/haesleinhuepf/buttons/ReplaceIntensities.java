...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ReplaceIntensitiesBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ReplaceIntensities extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ReplaceIntensitiesBlock();
