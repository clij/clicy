...
import plugins.haesleinhuepf.implementations.generated.CLIJx_LabelledSpotsToPointListBlock;
...
public class LabelledSpotsToPointList extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_LabelledSpotsToPointListBlock();
