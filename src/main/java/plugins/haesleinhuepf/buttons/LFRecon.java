...
import plugins.haesleinhuepf.implementations.generated.CLIJx_LFReconBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class LFRecon extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_LFReconBlock();
