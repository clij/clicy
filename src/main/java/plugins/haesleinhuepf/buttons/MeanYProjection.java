...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MeanYProjectionBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MeanYProjection extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_MeanYProjectionBlock();
