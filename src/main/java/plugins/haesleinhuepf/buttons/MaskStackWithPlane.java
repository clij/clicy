...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MaskStackWithPlaneBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class MaskStackWithPlane extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_MaskStackWithPlaneBlock();
