...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_Maximum2DBoxBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Maximum2DBox extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_Maximum2DBoxBlock();
