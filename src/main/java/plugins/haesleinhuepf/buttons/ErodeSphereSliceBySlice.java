...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ErodeSphereSliceBySliceBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ErodeSphereSliceBySlice extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ErodeSphereSliceBySliceBlock();
