...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_ErodeSphereSliceBySliceBlock;
...
public class ErodeSphereSliceBySlice extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_ErodeSphereSliceBySliceBlock();
