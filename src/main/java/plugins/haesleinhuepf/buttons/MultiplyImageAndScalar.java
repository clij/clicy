...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_MultiplyImageAndScalarBlock;
...
public class MultiplyImageAndScalar extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_MultiplyImageAndScalarBlock();
