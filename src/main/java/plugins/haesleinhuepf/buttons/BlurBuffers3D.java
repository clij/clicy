...
import plugins.haesleinhuepf.implementations.generated.CLIJx_BlurBuffers3DBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class BlurBuffers3D extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_BlurBuffers3DBlock();
