...
import plugins.haesleinhuepf.implementations.generated.CLIJx_TranslationTimelapseRegistrationBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class TranslationTimelapseRegistration extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_TranslationTimelapseRegistrationBlock();
