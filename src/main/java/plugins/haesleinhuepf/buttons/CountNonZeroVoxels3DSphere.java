...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_CountNonZeroVoxels3DSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CountNonZeroVoxels3DSphere extends EzPlug {

    AbstractCLIJ2Block plugin = new CLIJ2_CountNonZeroVoxels3DSphereBlock();
