...
import plugins.haesleinhuepf.implementations.generated.CLIJx_DrawSphereBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class DrawSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_DrawSphereBlock();
