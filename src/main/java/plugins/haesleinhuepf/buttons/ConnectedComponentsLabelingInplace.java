...
import plugins.haesleinhuepf.implementations.generated.CLIJx_ConnectedComponentsLabelingInplaceBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class ConnectedComponentsLabelingInplace extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_ConnectedComponentsLabelingInplaceBlock();
