...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_GreaterOrEqualConstantBlock;
...
public class GreaterOrEqualConstant extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_GreaterOrEqualConstantBlock();
