...
import plugins.haesleinhuepf.implementations.generated.CLIJx_AbsoluteInplaceBlock;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class AbsoluteInplace extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_AbsoluteInplaceBlock();
