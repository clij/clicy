...
import plugins.haesleinhuepf.implementations.generated.CLIJx_Minimum3DSphereBlock;

import javax.swing.*;
import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class Minimum3DSphere extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_Minimum3DSphereBlock();
