...
import plugins.haesleinhuepf.implementations.generated.CLIJx_WriteValuesToPositionsBlock;
...
public class WriteValuesToPositions extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_WriteValuesToPositionsBlock();
