...
import plugins.haesleinhuepf.implementations.generated.CLIJx_MultiplyImageAndCoordinateBlock;
...
public class MultiplyImageAndCoordinate extends EzPlug {
    ...
    AbstractCLIJxBlock plugin = new CLIJx_MultiplyImageAndCoordinateBlock();
