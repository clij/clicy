...
import plugins.haesleinhuepf.implementations.generated.CLIJx_SplitStackInto11Block;

import java.util.ArrayList;

// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class SplitStackInto11 extends EzPlug {

    AbstractCLIJxBlock plugin = new CLIJx_SplitStackInto11Block();
