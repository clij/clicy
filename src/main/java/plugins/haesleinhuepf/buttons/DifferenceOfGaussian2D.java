...
import plugins.haesleinhuepf.implementations.generated.CLIJ2_DifferenceOfGaussian2DBlock;
...
public class DifferenceOfGaussian2D extends EzPlug {
    ...
    AbstractCLIJ2Block plugin = new CLIJ2_DifferenceOfGaussian2DBlock();
