...
public class CLIJ2_ModeOfProximalNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_ModeOfProximalNeighborsMapBlock() {
        super(new ModeOfProximalNeighborsMap());
    }
