...
public class CLIJ2_MinimumOfTouchingNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MinimumOfTouchingNeighborsMapBlock() {
        super(new MinimumOfTouchingNeighborsMap());
    }
