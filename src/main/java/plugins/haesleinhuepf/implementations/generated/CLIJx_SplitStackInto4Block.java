...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto4;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto4Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto4Block() {
        super(new SplitStackInto4());
    }
