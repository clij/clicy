...
public class CLIJ2_MinimumTouchingNeighborDistanceMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MinimumTouchingNeighborDistanceMapBlock() {
        super(new MinimumTouchingNeighborDistanceMap());
    }
