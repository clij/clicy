...
public class CLIJ2_MinimumOfNNearestNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MinimumOfNNearestNeighborsMapBlock() {
        super(new MinimumOfNNearestNeighborsMap());
    }
