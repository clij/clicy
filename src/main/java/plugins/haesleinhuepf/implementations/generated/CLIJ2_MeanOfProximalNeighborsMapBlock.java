...
public class CLIJ2_MeanOfProximalNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MeanOfProximalNeighborsMapBlock() {
        super(new MeanOfProximalNeighborsMap());
    }
