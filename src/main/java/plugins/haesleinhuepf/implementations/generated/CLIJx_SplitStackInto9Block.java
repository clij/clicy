...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto9;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto9Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto9Block() {
        super(new SplitStackInto9());
    }
