...
public class CLIJ2_ProximalNeighborCountMapBlock extends AbstractCLIJ2Block {
     ...
     * 
     */
    public CLIJ2_ProximalNeighborCountMapBlock() {
        super(new ProximalNeighborCountMap());
    }
