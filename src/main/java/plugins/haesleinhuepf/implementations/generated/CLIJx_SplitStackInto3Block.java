...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto3;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto3Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto3Block() {
        super(new SplitStackInto3());
    }
