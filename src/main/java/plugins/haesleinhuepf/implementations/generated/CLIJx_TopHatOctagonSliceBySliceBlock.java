...
public class CLIJx_TopHatOctagonSliceBySliceBlock extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_TopHatOctagonSliceBySliceBlock() {
        super(new TopHatOctagonSliceBySlice());
    }
