...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto2;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto2Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto2Block() {
        super(new SplitStackInto2());
    }
