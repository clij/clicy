...
public class CLIJ2_MeanOfNNearestNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MeanOfNNearestNeighborsMapBlock() {
        super(new MeanOfNNearestNeighborsMap());
    }
