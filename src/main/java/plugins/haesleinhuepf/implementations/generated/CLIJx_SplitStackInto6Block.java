...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto6;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto6Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto6Block() {
        super(new SplitStackInto6());
    }
