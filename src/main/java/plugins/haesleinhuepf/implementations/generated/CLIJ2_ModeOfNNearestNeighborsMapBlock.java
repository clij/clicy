...
public class CLIJ2_ModeOfNNearestNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_ModeOfNNearestNeighborsMapBlock() {
        super(new ModeOfNNearestNeighborsMap());
    }
