...
public class CLIJ2_MaximumOfTouchingNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MaximumOfTouchingNeighborsMapBlock() {
        super(new MaximumOfTouchingNeighborsMap());
    }
