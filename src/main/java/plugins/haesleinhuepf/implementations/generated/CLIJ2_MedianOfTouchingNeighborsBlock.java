...
public class CLIJ2_MedianOfTouchingNeighborsBlock extends AbstractCLIJ2Block {
     ...
     * 
     */
    public CLIJ2_MedianOfTouchingNeighborsBlock() {
        super(new MedianOfTouchingNeighbors());
    }
