...
public class CLIJ2_MaximumOfNNearestNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MaximumOfNNearestNeighborsMapBlock() {
        super(new MaximumOfNNearestNeighborsMap());
    }
