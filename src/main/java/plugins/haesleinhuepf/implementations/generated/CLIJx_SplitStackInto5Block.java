...
import net.haesleinhuepf.clijx.advancedfilters.splitstack.SplitStackInto5;
// this is generated code. See src/test/java/net/haesleinhuepf/clicy/codegenerator for details
public class CLIJx_SplitStackInto5Block extends AbstractCLIJxBlock {
     ...
     */
    public CLIJx_SplitStackInto5Block() {
        super(new SplitStackInto5());
    }
