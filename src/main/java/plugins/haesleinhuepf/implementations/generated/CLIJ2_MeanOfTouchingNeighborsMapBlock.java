...
public class CLIJ2_MeanOfTouchingNeighborsMapBlock extends AbstractCLIJ2Block {
     ...
     */
    public CLIJ2_MeanOfTouchingNeighborsMapBlock() {
        super(new MeanOfTouchingNeighborsMap());
    }
